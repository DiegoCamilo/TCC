...
class TurmasControllerTest < ActionController::TestCase
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post :create, turma: { nome: @turma.nome, periodo_turma: @turma.periodo_turma, turno: @turma.turno }
    end
  ...
  test "should update turma" do
    put :update, id: @turma, turma: { nome: @turma.nome, periodo_turma: @turma.periodo_turma, turno: @turma.turno }
    assert_redirected_to turma_path(assigns(:turma))
  end
